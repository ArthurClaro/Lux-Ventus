...
function FormRegister() {
    ...
    return (
        ...
        <>
            ...
            <br />
            <div className="card flex justify-content-center">
                <Password value={confirm} onChange={(e) => setConfirm(e.target.value)} toggleMask />
            </div>
            <br />
            <div className="card flex justify-content-center">
                <span className="p-float-label">
                    <Password inputId="password" value={other} onChange={(e) => setOther(e.target.value)} toggleMask/>
